    ...
    <>
      ...
      <div className=" bg-white ">
        ...
        <div className="relative">
          <div className="absolute w-full h-[40%] translate-y-[-195px] z-50 lg:text-2xl md:text-xl text-lg justify-center text-center font-semibold text-black hover:text-stone-50 rounded-lg">
